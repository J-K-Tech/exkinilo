...
public class PerlinNoiseGenerator2d {  	public static float AMPLITUDE = 80f;
    ...
    public PerlinNoiseGenerator2d() {
    }

    //only works with POSITIVE gridX and gridZ values!
    public PerlinNoiseGenerator2d(int gridX, int gridZ, int vertexCount, int seed) {
        this.seed = seed;
